                                            ...
                                            <center>
                                                <div class="btn-group">
                                                    <a href="update.php?id=<?php echo $id_rol; ?>" type="button" class="btn btn-success">
                                                        ...
                                                        <button type="button" class="btn btn-info showModal" data-toggle="modal" data-target="#showModal" data-id="<?= $id_rol; ?>">
...
$(document).ready(function() {
    $('.showModal').click(function() {
        ...
        // Cargar el contenido del modal desde permisos.php, pasando el ID
        $.get('permisos.php', { id: id }, function(data) {
            ...
            $('#showModal').on('hidden.bs.modal', function () {
                $(this).remove(); // Eliminar el modal del DOM después de cerrarlo
            });
        });
    });
});
