...
<?php
include_once(__DIR__ . '/../app/controllers/permisos/help.php');

                         //session_start();
$permisos = $_SESSION['permisos'] ?? [];

// Depuración para ver si los permisos están cargados correctamente
/*echo "<pre>";
print_r($permisos);
echo "</pre>";*/
...
?>
                    ...
                    <?php }
if (tiene_permiso('Permisos', 'Ver', $permisos)) {
    // Si el usuario tiene permiso, muestra esta parte
?>
                    <li class="nav-item ">
                        <a href="#" class="nav-link active">
