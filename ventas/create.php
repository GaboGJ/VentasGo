                                    ...
                                    $('#btn_guardar_venta').click(function () {
                                        ...
                                        function guardar_venta() {
                                            ...
                                            $.get(url, {nro_venta: nro_venta, id_cliente: id_cliente, total_a_cancelar: total_a_cancelar}, function (datos) {
                                                ...
                                                // Llamar a la generación del ticket una vez que se guarda la venta
                                                generar_ticket(nro_venta, id_cliente, total_a_cancelar);
                                            });
                                        }

                                        // Función para generar el ticket de venta
                                        function generar_ticket(nro_venta, id_cliente, total_a_cancelar) {
                                            var url_ticket = "ticket.php?nro_venta=" + nro_venta + "&id_cliente=" + id_cliente + "&total_a_cancelar=" + total_a_cancelar;
                                            ...
                                            // Cargar el ticket en el iframe
                                            iframe.src = url_ticket;
                                            ...
                                            iframe.onload = function() {
                                                ...
                                                setTimeout(function() {
                                                    ...
                                                    window.location.href = 'create.php'; // Redirigir a la página de ventas
